...
const ShieldedTokenAmountInput = ({
  balances,
  selectedToken,
  maxAmount,
  validate,
  ...
  const tokenAddressField = getFieldName(TokenAmountFields.shieldedTokenAddress, fieldArray)
...
export default ShieldedTokenAmountInput
